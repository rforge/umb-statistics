...
createSequence <- function(){
  ...
  radioButtonsUMB(byFrame,name="byOut", buttons=c("by", "length.out"), values=c("by", "length.out"), initialValue = "by",
  ...
  radioButtonsUMB(repsFrame,name="repsOut", buttons=c("all", "each"), values=c("all", "each"), initialValue = "all",
